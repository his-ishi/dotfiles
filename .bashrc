...
HISTFILESIZE=20000
SAVEHIST=100000
export WINEDITOR HISTSIZE HISTFILESIZE SAVEHIST
...
PRECEEDING_PATH=$PRECEEDING_PATH:"/c/Python310/Scripts:/c/Python310"
...
# prompt
COLO=$(calc_color_hash)
PS1="[\[\e[1;\${COLO}m\]\h \[\e[36m\]\W \[\e[32m\]\$(parse_git_branch)\[\e[0m\]]\$ "
export PS1
